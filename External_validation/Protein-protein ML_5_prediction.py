...
fasta_dir = r'./'
worksheet_path = r'./HPV18_predictions_final.xlsx' 
...
def load_data(worksheet_path, fasta_dir):
    ...
    for i, row in df.iterrows():
        ...
        data.append(((sequences1, sequences2)))
    return data

      
# Load protein sequence pairs
test_data = load_data(worksheet_path, fasta_dir)
...
test_sequences1 = np.array([pair[0] for pair in test_data])
test_sequences2 = np.array([pair[1] for pair in test_data])
